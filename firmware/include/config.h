...
#define USB_VENDOR_ID       0x1189      // original keypad VID
#define USB_PRODUCT_ID      0x8890      // original keypad PID
#define USB_DEVICE_VERSION  0x0200      // v2.0 (BCD-format)
...
#define PRODUCT_STR         'C','H','5','5','2',' ','R','G','B',' ','M','a','c','r','o','P','a','d'
